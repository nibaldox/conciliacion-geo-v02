...
CANONICAL_FIELDS: tuple[CanonicalField, ...] = (
    ...
    CanonicalField("Incl",           True,  "Inclinación desde vertical", "°",  ("Inclinacion_real", "Dip", "Inclinacion", "Inclination", "Incl")),
    CanonicalField("Az",             True,  "Azimut (desde Norte)",       "°",  ("Azimuth_real", "Heading", "Azimuth", "Azimut", "Az", "Bearing")),
