...
via a GitHub issue marked `private` or by contacting the maintainer
directly through their profile at
[nibaldox](https://github.com/nibaldox). All complaints will be
...
or community communication with the community. During this period,
the contributor must not post or comment publicly, or interact
indirectly (e.g., via social media) with the people involved. The
community leaders may also require the contributor to issue a public
apology before reinstating their participation.
